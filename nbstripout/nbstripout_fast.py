...
# filters the content as is. But it does that about 10-15+ times
# faster. It seems that the native python json beats rapidjson, but if
# you want it to use a rapidjson pass -r option.
#
#
...
# the config files to nbstripout-fast, or manually add:
#
# .gitconfig:
# [filter "nbstripout"]
...
def main():
    ...
    parser.add_argument("-r", action="store_true", help="use rapidjson version")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "--doc-mode",
        action="store_true",
        help="fastai docs nb-specific strip out",
    )
    parser.add_argument(
        "-v",
        "--version",
    ...
    # rapidjson should be faster than json - but here it is not
    # try:
